 ...
 */
Test(initialization_suite, initialization, .timeout = TEST_TIMEOUT)
{
	size_t sz = 1;
	void *p  = sf_malloc(sz);
 ...
 */
Test(single_malloc_suite, malloc_1, .timeout = TEST_TIMEOUT)
{
...
Test(single_malloc_suite, malloc_16, .timeout = TEST_TIMEOUT)
{
	size_t sz = 16;
	void *x = sf_malloc(sz);
	_assert_nonnull_payload_pointer(x);
...
Test(single_malloc_suite, malloc_32, .timeout = TEST_TIMEOUT)
{
	size_t sz = 32;
	void *x = sf_malloc(sz);
	_assert_nonnull_payload_pointer(x);
 ...
 */
Test(single_malloc_suite, exactly_one_page, .timeout = TEST_TIMEOUT)
{
	size_t sz = 1976;
	void *x = sf_malloc(sz);
	_assert_nonnull_payload_pointer(x);
 ...
 */
Test(single_malloc_suite, more_than_one_page, .timeout = TEST_TIMEOUT)
{
	size_t sz = 2008;
	void *x = sf_malloc(sz);
	_assert_nonnull_payload_pointer(x);
 ...
 */
Test(single_malloc_suite, three_pages, .timeout = TEST_TIMEOUT)
{
 ...
 */
Test(single_malloc_suite, malloc_max, .timeout = TEST_TIMEOUT)
{
	size_t sz = 128953;
	void *x = sf_malloc(sz);
 ...
 */
Test(malloc_free_suite, no_coalesce, .timeout = TEST_TIMEOUT)
{
...
Test(malloc_free_suite, coalesce_lower, .timeout = TEST_TIMEOUT)
{
	void *x = sf_malloc(200);
	_assert_nonnull_payload_pointer(x);
	_assert_block_info(x - 8, 1, 224);
...
Test(malloc_free_suite, coalesce_upper, .timeout = TEST_TIMEOUT)
{
	void *x = sf_malloc(200);
	_assert_nonnull_payload_pointer(x);
	_assert_block_info(x - 8, 1, 224);
...
Test(malloc_free_suite, coalesce_both, .timeout = TEST_TIMEOUT)
{
	void *x = sf_malloc(200);
	_assert_nonnull_payload_pointer(x);
	_assert_block_info(x - 8, 1, 224);
...
Test(malloc_free_suite, first_block, .timeout = TEST_TIMEOUT)
{
	void *x = sf_malloc(200);
	_assert_nonnull_payload_pointer(x);
	_assert_block_info(x - 8, 1, 224);
...
Test(malloc_free_suite, last_block, .timeout = TEST_TIMEOUT)
{
	void *x = sf_malloc(200);
	_assert_nonnull_payload_pointer(x);
	_assert_block_info(x - 8, 1, 224);
 ...
 */
Test(single_malloc_suite, splinter, .timeout = TEST_TIMEOUT)
{
 ...
 */
Test(stress_suite, malloc_to_exhaustion, .timeout = TEST_TIMEOUT)
{
    size_t size = 90;
    size_t asize = 128;
    int limit = 10000;
 ...
 */
Test(memalign_suite, test_1a, .timeout = TEST_TIMEOUT)
{
...
Test(memalign_suite, test_1b, .timeout = TEST_TIMEOUT)
{
...
Test(memalign_suite, test_1c, .timeout = TEST_TIMEOUT)
{
 ...
 */
Test(memalign_suite, test_2, .timeout = TEST_TIMEOUT)
{
    size_t arg_align = 32;
    size_t arg_size = 25;  // Arbitrary
 ...
 */
Test(memalign_suite, test_3, .timeout = TEST_TIMEOUT)
{
