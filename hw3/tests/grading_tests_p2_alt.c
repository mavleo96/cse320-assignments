 ...
 */
Test(lifo_suite, malloc_free_lifo_alt, .timeout=TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 200;
    size_t asz = 224;
    void * x = sf_malloc(sz);
 ...
 * Realloc tests.
 */
Test(realloc_suite, realloc_larger_alt, .timeout=TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 200;
    size_t asz = 224;
    size_t nsz = 1024;
...
Test(realloc_suite, realloc_smaller_alt, .timeout=TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 1024;
    size_t asz = 1056;
    size_t nsz = 200;
...
Test(realloc_suite, realloc_same_alt, .timeout=TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 1024;
    size_t asz = 1056;
    size_t nsz = 1024;
...
Test(realloc_suite, realloc_splinter_alt, .timeout=TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 1024;
    size_t asz = 1056;
    size_t nsz = 1020;
...
Test(realloc_suite, realloc_size_0_alt, .timeout=TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 512;
    size_t asz = 544;
    void * x = sf_malloc(sz);
...
Test(realloc_suite, realloc_preserves_payload_alt, .timeout=TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 200;
    size_t asz = 224;
    size_t nsz = 1024;
 ...
 */
Test(illegal_pointer_suite, free_null_alt, .signal = SIGABRT, .timeout = TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 1;
    (void) sf_malloc(sz);
    sf_free(NULL);
...
Test(illegal_pointer_suite, free_unallocated_alt, .signal = SIGABRT, .timeout = TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 1;
    void *x = sf_malloc(sz);
    sf_free(x);
...
Test(illegal_pointer_suite, free_block_too_small_alt, .signal = SIGABRT, .timeout = TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 1;
    void * x = sf_malloc(sz);
...
Test(illegal_pointer_suite, free_prev_alloc_alt, .signal = SIGABRT, .timeout = TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    size_t sz = 1;
    void * w = sf_malloc(sz);
    void * x = sf_malloc(sz);
...
// allocated blocks.
Test(stress_suite, stress_test_alt, .timeout = TEST_TIMEOUT, .init=set_16_byte_alignment)
{
    errno = 0;
